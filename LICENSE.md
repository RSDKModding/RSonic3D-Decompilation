# RETRO-SONIC ENGINE DECOMPILATION SOURCE CODE LICENSE v1

The code in this repository is a decompilation of RSDK (Retro-Sonic Engine).
...
Decompilation authors: RSDKModding Team